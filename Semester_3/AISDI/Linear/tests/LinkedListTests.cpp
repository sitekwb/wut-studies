...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollection_WhenCreatedWithDefaultConstructor_ThenItIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenAddingItem_ThenItIsNoLongerEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenGettingIterators_ThenBeginEqualsEnd,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenGettingIterator_ThenBeginIsNotEnd,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollectionWithOneElement_WhenIterating_ThenElementIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenIterator_WhenPostIncrementing_ThenPreviousPositionIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenIterator_WhenPreIncrementing_ThenNewPositionIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEndIterator_WhenIncrementing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEndIterator_WhenDecrementing_ThenIteratorPointsToLastItem,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenIterator_WhenPreDecrementing_ThenNewIteratorValueIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenIterator_WhenPostDecrementing_ThenOldIteratorValueIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenBeginIterator_WhenDecrementing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEndIterator_WhenDereferencing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenConstIterator_WhenDereferencing_ThenItemIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenIterator_WhenDereferencing_ThenItemCanBeChanged,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 10, 20, 30 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenIterator_WhenAddingInteger_ThenAdvancedIteratorIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenIterator_WhenSubstractingInteger_ThenChangedIteratorIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 2001, 2010, 2051 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollection_WhenInitializingFromList_ThenAllItemsAreInCollection,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenCreatingCopy_ThenAllItemsAreCopied,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenCreatingCopy_ThenBothCollectionsAreEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenMovingToOther_ThenAllItemsAreMoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1410, 753, 1789 };
  ...
  thenCollectionContainsValues(other, { 1410, 753, 1789 });
  thenConstructedObjectsCountWas<T>(SENTINELS_NUMBER);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenMovingToOther_ThenSecondCollectionsIsEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenAssigningToOther_ThenAllElementsAreCopied,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenAssigningToOther_ThenOtherCollectionIsEmpty,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenSelfAssigning_ThenNothingHappens,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNotEmptyCollection_WhenSelfAssigning_ThenNothingHappens,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenMoveAssigning_ThenAllElementsAreMoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenMoveAssigning_ThenNewCollectionIsEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollection_WhenAppendingItem_ThenItemIsLast,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenPrependingItem_ThenItemIsAdded,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPrependingItem_ThenItemIsFirst,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenGettingSize_ThenZeroIsReturned,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenGettingSize_ThenElementCountIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollection_WhenChangingIt_ThenItsSizeAlsoChanges,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPrependingItem_ThenSizeIsUpdated,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 72, 27, 77 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenInsertingItem_ThenItemIsAdded,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenInsertingAtBegin_ThenItemIsPrepended,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenInsertingAtEnd_ThenItemIsAppended,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 11, 12, 13 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenInsertingInMiddle_ThenItemInserted,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 11, 12, 13 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenInserting_ThenSizeIsUpdated,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenPoppingFirst_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenPoppingLast_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollectionWithSingleItem_WhenPoppingFirst_ThenCollectionIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollectionWithSingleItem_WhenPoppingLast_ThenCollectionIsEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 420 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPoppingFirst_ThenCollectionSizeIsReduced,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPoppingLast_ThenCollectionSizeIsReduced,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 14, 10 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPoppingFirst_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPoppingLast_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 300, 8, 480 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPoppingFirst_ThenItemsIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPoppingLast_ThenItemsIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 101, 202, 303 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenEmptyCollection_WhenErasing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingEnd_ThenOperationThrows,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingBegin_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingLastItem_ThemItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingMiddleItem_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasing_ThenSizeIsReduced,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenCollectionWithSingleItem_WhenErasing_ThenCollectionIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingEmptyRange_ThenNothingHappens,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingRangeFromBegin_ThenItemsAreRemoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 19, 42, 11 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_whenErasingRangeToEnd_ThenItemsAreRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingSingleItemRange_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingWholeRange_ThenCollectinIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingRange_ThenSizeIsUpdated,
                              T,
                              TestedTypes)
{
...
//own tests
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenPrependingElement_ThenItIsBegin,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingManyElements_ThenItDeletsThem,
                                  T,
                                  TestedTypes)
    {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenInsertingElement_ThenItContainsIt,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 20, 80, 100, 130, 2, 8, 0 };
 ...
 BOOST_AUTO_TEST_CASE_TEMPLATE(LGivenNonEmptyCollection_WhenErasingEnd_ThenItThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
