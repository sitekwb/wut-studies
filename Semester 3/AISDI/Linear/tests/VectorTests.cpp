...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollection_WhenCreatedWithDefaultConstructor_ThenItIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenAddingItem_ThenItIsNoLongerEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenGettingIterators_ThenBeginEqualsEnd,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenGettingIterator_ThenBeginIsNotEnd,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollectionWithOneElement_WhenIterating_ThenElementIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
//here before
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenIterator_WhenPostIncrementing_ThenPreviousPositionIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenIterator_WhenPreIncrementing_ThenNewPositionIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEndIterator_WhenIncrementing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEndIterator_WhenDecrementing_ThenIteratorPointsToLastItem,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenIterator_WhenPreDecrementing_ThenNewIteratorValueIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenIterator_WhenPostDecrementing_ThenOldIteratorValueIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenBeginIterator_WhenDecrementing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEndIterator_WhenDereferencing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
//here
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenConstIterator_WhenDereferencing_ThenItemIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenIterator_WhenDereferencing_ThenItemCanBeChanged,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 10, 20, 30 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenIterator_WhenAddingInteger_ThenAdvancedIteratorIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenIterator_WhenSubstractingInteger_ThenChangedIteratorIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 2001, 2010, 2051 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenAddingItem_ThenItemIsInCollection,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollection_WhenInitializingFromList_ThenAllItemsAreInCollection,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenCreatingCopy_ThenAllItemsAreCopied,
                              T,
                              TestedTypes)
{
...
//here after passed
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenCreatingCopy_ThenBothCollectionsAreEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenMovingToOther_ThenAllItemsAreMoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1410, 753, 1789 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenMovingToOther_ThenSecondCollectionsIsEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenAssigningToOther_ThenAllElementsAreCopied,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenAssigningToOther_ThenOtherCollectionIsEmpty,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenSelfAssigning_ThenNothingHappens,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNotEmptyCollection_WhenSelfAssigning_ThenNothingHappens,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenMoveAssigning_ThenAllElementsAreMoved,
                              T,
                              TestedTypes)
{
  ...
  thenAssignedObjectsCountWas<T>(0);
  thenMovedObjectsCountWas<T>(0);
  thenDestroyedObjectsCountWas<T>(INIT_SIZE);
}

BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenMoveAssigning_ThenNewCollectionIsEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollection_WhenAppendingItem_ThenItemIsLast,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenPrependingItem_ThenItemIsAdded,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPrependingItem_ThenItemIsFirst,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenGettingSize_ThenZeroIsReturned,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenGettingSize_ThenElementCountIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollection_WhenChangingIt_ThenItsSizeAlsoChanges,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPrependingItem_ThenSizeIsUpdated,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 72, 27, 77 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenInsertingItem_ThenItemIsAdded,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenInsertingAtBegin_ThenItemIsPrepended,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenInsertingAtEnd_ThenItemIsAppended,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 11, 12, 13 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenInsertingInMiddle_ThenItemInserted,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 11, 12, 13 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenInserting_ThenSizeIsUpdated,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenPoppingFirst_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenPoppingLast_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollectionWithSingleItem_WhenPoppingFirst_ThenCollectionIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollectionWithSingleItem_WhenPoppingLast_ThenCollectionIsEmpty,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 420 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPoppingFirst_ThenCollectionSizeIsReduced,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPoppingLast_ThenCollectionSizeIsReduced,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 14, 10 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPoppingFirst_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPoppingLast_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 300, 8, 480 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPoppingFirst_ThenItemsIsReturned,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPoppingLast_ThenItemsIsReturned,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 101, 202, 303 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenEmptyCollection_WhenErasing_ThenOperationThrows,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingEnd_ThenOperationThrows,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingBegin_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingLastItem_ThemItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingMiddleItem_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasing_ThenSizeIsReduced,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenCollectionWithSingleItem_WhenErasing_ThenCollectionIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingEmptyRange_ThenNothingHappens,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingRangeFromBegin_ThenItemsAreRemoved,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 19, 42, 11 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_whenErasingRangeToEnd_ThenItemsAreRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingSingleItemRange_ThenItemIsRemoved,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingWholeRange_ThenCollectinIsEmpty,
                              T,
                              TestedTypes)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingRange_ThenSizeIsUpdated,
                              T,
                              TestedTypes)
{
...
//own tests
    BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenPrependingElement_ThenItIsBegin,
                                  T,
                                  TestedTypes)
    {
      LinearCollection<T> collection = { 18, 15, 9, 200 };

      collection.prepend(1200);

      BOOST_CHECK_EQUAL(*collection.begin(), 1200);

    }

    BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingManyElements_ThenItDeletsThem,
                                  T,
                                  TestedTypes)
    {
      LinearCollection<T> collection = { 20, 80, 100, 130, 2, 8, 0 };

      collection.erase(collection.begin()+2, collection.begin()+5);

      thenCollectionContainsValues(collection, { 20, 80, 8, 0 });

    }
    BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenInsertingElement_ThenItContainsIt,
                                  T,
                                  TestedTypes)
    {
      LinearCollection<T> collection = { 20, 80, 100, 130, 2, 8, 0 };

      collection.insert(collection.begin()+2, 44);

      thenCollectionContainsValues(collection, { 20, 80, 44, 100, 130, 2, 8, 0 });

    }

    BOOST_AUTO_TEST_CASE_TEMPLATE(VGivenNonEmptyCollection_WhenErasingEnd_ThenItThrows,
                                  T,
                                  TestedTypes)
    {
      LinearCollection<T> collection;

      BOOST_CHECK_THROW(collection.erase(collection.end()), std::out_of_range);
