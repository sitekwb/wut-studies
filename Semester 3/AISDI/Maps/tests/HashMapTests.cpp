...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyMap_WhenGettingBegin_ItShowsRightValue,
                              K,
                              TestedKeyTypes)
{
    const Map<K> map = { { 42, "Alice" }, { 27, "Bob" }, { 13, "Chuck" }, { 7, "Kuba"}, { 18, "Michal"}, { 26, "Kamil" } };

    auto it = map.begin();
    BOOST_CHECK( it->second == "Kuba");
}

BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyMap_WhenTakingValueOfNotExisting_ThenItThrows,
                              K,
                              TestedKeyTypes)
{
    const Map<K> map = { { 42, "Alice" }, { 27, "Bob" }, { 13, "Chuck" }, { 7, "Kuba"}, { 18, "Michal"}, { 26, "Kamil" } };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyMap_WhenFindingNonExisting_ThenItEqualsEnd,
                              K,
                              TestedKeyTypes)
{
    const Map<K> map = { { 42, "Alice" }, { 27, "Bob" }, { 13, "Chuck" }, { 7, "Kuba"}, { 18, "Michal"}, { 26, "Kamil" } };

    BOOST_CHECK(map.find(5) == map.end());
}
